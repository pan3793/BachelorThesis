...
\begin{thebibliography}{99}
    ...
    \bibitem{gradle} Gradle in Action，Author Benjamin Muschko, Published by Manning Publications, 2014-3-9, ISBN: 9781617291302.
    ...
    \bibitem{mooc} 慕课在我国的发展现状，张洪东，《中国教育信息化》杂志，2016-01-11。
    \bibitem{jetbrains} Jetbrains官方网站，\url{http://www.jetbrains.com/}
    \bibitem{alibaba-java-coding-guidelines} 阿里巴巴Java开发手册，\url{https://github.com/alibaba/p3c}
    \bibitem{spring-boot} Spring Boot in Action, Author Craig Walls, Published by Manning Publications, 2016-1-3, ISBN: 9781617292545.
    \bibitem{service-discovery-in-a-microservices-architecture} Service Discovery in a Microservices Architecture，Chris Richardson of Eventuate, Inc. October 12, 2015.
    \bibitem{cap} Gilbert S, Lynch N. Perspectives on the CAP Theorem[M]. IEEE Computer Society Press, 2012.
    \bibitem{tomcat} Tomcat内核设计剖析，汪建著。人民邮电出版社，2017年06月。
    \bibitem{uuid} Leach, Paul, and R. Salz. "UUIDs and GUIDs." (1998).
    \bibitem{fully-executable} Service wrappers for spring boot application，\url{https://github.com/spring-projects/spring-boot/issues/519}
\end{thebibliography}
\end{document}
